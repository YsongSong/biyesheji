        ...
        <div class="login1">
            <div class="login2">
                <div class="loginTopDiv">
                    <span class="loginTop">编辑登录</span>
                    <span>
                <a href="" class="registBtn"></a>
              </span>
                </div>
                <div>
                    <form target="_top" action="${pageContext.request.contextPath}/toEditorLogin.do" method="post" id="loginForm">
                        ...
                        <table>
                            ...
                            <tr>
                                <td width="50">用户名</td>
                                <td><input class="input" type="text" name="username" id="loginname" value="${editorInfo.username}"/></td>
                            </tr>
                            <tr>
                                <td height="20">&nbsp;</td>
