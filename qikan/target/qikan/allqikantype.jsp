...
<head>
    ...
    <title>学术期刊</title>
    <link rel="stylesheet" href="css/forground/home.css" />
    <link rel="stylesheet" href="css/forground/index.css" />
    <link rel="stylesheet" href="css/forground/loginDialog.css" />
    <link rel="stylesheet" href="css/forground/qikan.css" />
...
<div class="w1060 pos_r">
    ...
    <div class="w1060">
        ...
        <!-- 期刊列表 start -->
        <c:forEach var="page" items="${pb}">

            <div id="a1" class="qikan_box">
            <div class="qikan_tit"><em></em><span>${page.type.typename}</span><a href="${pageContext.request.contextPath}/periodical/index.do?typeId=${page.type.typeid}" target="_blank">更多&gt;</a></div>
            <ul>

                <c:forEach var="qikan" items="${page.qikanList}">
                    <li><a href="${pageContext.request.contextPath}/periodical/${qikan.qikanid}.html">
                        <div class="qikan_img">
                            <img src="${pageContext.request.contextPath}/${qikan.image}" />
                        </div>
                        <p>${qikan.qikanname}</p>
                        <span>${qikan.jibie}</span></a>
                    </li>
                </c:forEach>
