			...
			<div id="side-nav">
				<ul id="nav">
					...
					<li>
						...
						<ul class="sub-menu">
							<li>
								<a _href="authormanager.html">
									<i class="iconfont">&#xe6a7;</i>
									<cite>作者管理</cite>
								</a>
							</li>
							<li>
								<a _href="editormanager.html">
									<i class="iconfont">&#xe6a7;</i>
									<cite>编辑管理</cite>
								</a>
							</li>
							<li>
								<a _href="expertmanager.html">
									<i class="iconfont">&#xe6a7;</i>
									<cite>专家管理</cite>
								</a>
							</li>
					...
					<li>
						...
						<ul class="sub-menu">
							<li>
								<a _href="qikantype.html">
									<i class="iconfont">&#xe6a7;</i>
									<cite>类别管理</cite>
								</a>
							</li>
							<li>
								<a _href="qikanmanage.html">
									<i class="iconfont">&#xe6a7;</i>
									<cite>期刊管理</cite>
								</a>
								<ul class="sub-menu">
					...
					<li>
						...
						<ul class="sub-menu">
							<li>
								<a _href="publishedArticles.html">
									<i class="iconfont">&#xe6a7;</i>
									<cite>已发表信息</cite>
								</a>
							</li>
