							...
							<c:forEach var="checkUp" items="${pb.beanList}" varStatus="status">
								...
								<tr>
									...
									<td id="editStatus">
										...
										<c:choose>
											<c:when test="${checkUp.adminMessage} == 0">
												同意发表
											</c:when>
											<c:otherwise>
												不同意发表
									...
									<td class="td-manage" style="text-align: center;">
										...
										<a onclick="WeAdminShow('发表','${pageContext.request.contextPath}/editor/tofabiao.do?checkId=${checkUp.cheekid}',600,400)" href="javascript:;" title="发表">
											<i class="layui-icon">&#xe609;</i>
										</a>
										<a onclick="WeAdminShow('退稿','totuigao.html',600,400)" href="javascript:;" title="退稿">
											<i class="layui-icon">&#xe640;</i>
										</a>
									</td>
								</tr>
