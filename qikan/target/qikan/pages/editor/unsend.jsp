						...
						<c:otherwise>
							...
							<c:forEach var="article" items="${pb.beanList}" varStatus="status">
								...
								<tr>
									...
									<td>${article.author.rellname}</td>
									<td>${article.articlecnkeywords}</td>
									<td id="qikan">${article.qikan.qikanname}</td>
									<td id="receiveArticleTime">${article.receivearticletime}</td>
									<td class="td-manage" style="text-align: center;">
										...
										<a onclick="WeAdminShow('稿件分派','${pageContext.request.contextPath}/editor/tosend.do?articleId=${article.articleid}&typeId=${article.qikan.type.typeid}',600,420)" href="javascript:;" title="稿件分派">
											<i class="layui-icon">&#xe6b2;</i>
										</a>
									</td>
								</tr>
